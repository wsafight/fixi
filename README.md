...
```bash
curl https://raw.githubusercontent.com/bigskysoftware/fixi/refs/tags/0.0.2/fixi.js >> fixi-0.0.2.js
```

The SHA256 of v0.0.2 is 

`SpWHzb/DZ1M2+9c4/GMd0aICXTSylNTROXZ17n/PSLU=`
...
<script src="https://cdn.jsdelivr.net/gh/bigskysoftware/fixi@0.0.2/fixi.js"
