...
The current uncompressed size is `3688` bytes and the gzip'd size is `1394` bytes as determined by:
...
```bash
curl https://raw.githubusercontent.com/bigskysoftware/fixi/refs/tags/0.2.0/fixi.js >> fixi-0.2.0.js
```

The SHA256 of v0.2.0 is 

`5jZPqeyqD3UdUDVCQ2D7U7KzLEIKWWDl2v78qEnn4hQ=`
...
<https://github.com/bigskysoftware/fixi/archive/refs/tags/0.2.0.zip>

You can also use the JSDelivr CDN for local development or testing:

```html
<script src="https://cdn.jsdelivr.net/gh/bigskysoftware/fixi@0.2.0/fixi.js"
        crossorigin="anonymous"
        integrity="sha256-5jZPqeyqD3UdUDVCQ2D7U7KzLEIKWWDl2v78qEnn4hQ="></script>
```
