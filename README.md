...
The current uncompressed size is `3410` bytes and the gzip'd size is `1322` bytes as determined by:
...
```bash
curl https://raw.githubusercontent.com/bigskysoftware/fixi/refs/tags/0.0.5/fixi.js >> fixi-0.0.5.js
```

The SHA256 of v0.0.5 is 

`tH2zdt7iN8DtZ28rjt8rJRLvaOmYBVRA+E+NxzC/gqM=`
...
<script src="https://cdn.jsdelivr.net/gh/bigskysoftware/fixi@0.0.5/fixi.js"
        integrity="sha256-tH2zdt7iN8DtZ28rjt8rJRLvaOmYBVRA+E+NxzC/gqM="></script>
```
