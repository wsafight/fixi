...
```bash
curl https://raw.githubusercontent.com/bigskysoftware/fixi/refs/heads/v0.0.1/fixi.js >> fixi-v0.0.1.js
```
...
<script src="https://cdn.jsdelivr.net/gh/bigskysoftware/fixi@0.0.1/fixi.js"></script>
```
