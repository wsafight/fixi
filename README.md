...
```bash
curl https://raw.githubusercontent.com/bigskysoftware/fixi/refs/tags/0.0.3/fixi.js >> fixi-0.0.3.js
```

The SHA256 of v0.0.3 is 

`OPXsO0bHpwahn2RVfhthoFrhA8erFrNxPlEXJvtjzns=`
...
<script src="https://cdn.jsdelivr.net/gh/bigskysoftware/fixi@0.0.3/fixi.js"
