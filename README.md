...
The current uncompressed size is `3621` bytes and the gzip'd size is `1379` bytes as determined by:
...
```bash
curl https://raw.githubusercontent.com/bigskysoftware/fixi/refs/tags/0.1.0/fixi.js >> fixi-0.1.0.js
```

The SHA256 of v0.1.0 is 

`DeCpkkb9KAnZYGj+/9zBxiuqAwvldzTYnYKSPYs4q8o=`
...
<script src="https://cdn.jsdelivr.net/gh/bigskysoftware/fixi@0.1.0/fixi.js"
        integrity="sha256-DeCpkkb9KAnZYGj+/9zBxiuqAwvldzTYnYKSPYs4q8o="></script>
```
