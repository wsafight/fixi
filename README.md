...
The current uncompressed size is `3573` bytes and the gzip'd size is `1366` bytes as determined by:
...
```bash
curl https://raw.githubusercontent.com/bigskysoftware/fixi/refs/tags/0.0.9/fixi.js >> fixi-0.0.9.js
```

The SHA256 of v0.0.9 is 

`SO7Nm7fBUb6NpsyCbJYpuxRxA4/ByMCVTsSW3NFAtyw=`
...
<script src="https://cdn.jsdelivr.net/gh/bigskysoftware/fixi@0.0.9/fixi.js"
        integrity="sha256-SO7Nm7fBUb6NpsyCbJYpuxRxA4/ByMCVTsSW3NFAtyw="></script>
```
