...
```bash
curl https://raw.githubusercontent.com/bigskysoftware/fixi/refs/tags/0.0.7/fixi.js >> fixi-0.0.7.js
```

The SHA256 of v0.0.7 is 

`z0z+R3324dCmVm3en4WzaYO3lAlb57q21RQUZ3h65y4=`
...
<script src="https://cdn.jsdelivr.net/gh/bigskysoftware/fixi@0.0.7/fixi.js"
        integrity="z0z+R3324dCmVm3en4WzaYO3lAlb57q21RQUZ3h65y4="></script>
```
